...
export const SCOPE =
  'user-read-private user-modify-playback-state streaming playlist-read-private user-read-recently-played app-remote-control';
// export const SCOPE =
//   'user-read-recently-played user-read-private user-modify-playback-state ';
